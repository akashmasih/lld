...
import type { ApiError, LoginBody, LoginResponse } from "../features/auth/types/auth.types"
...
{/* <div>
            ...
            <form onSubmit={handleSubmit(submit)}>
                ...
                <button className="px-4 py-2 bg-purple-500 text-white rounded-sm" type="submit">Login</button>
            </form>
